  ...
  return (
    <div>
      <div className="mb-5">
        ...
        <span className="t-chain mt-2 block text-3xl text-[var(--color-ochre-300)]">
          {usd(mp.prizePool)}
        </span>
      </div>
      ...
      <DataRow
        ...
        ink={mp.stalled ? "var(--color-sinopia-400)" : "var(--color-travertine)"}
      />

      {mp.hasWinnings ? (
        <div className="mt-6">
          <p className="mb-3 text-[1.0625rem] text-[var(--color-ochre-300)]">
